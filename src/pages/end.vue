...
<template>
  <div class="final h-screen">
    <a
      ...
      target="_blank"
      class="z-1000 fixed top-36px lt-lg:top-unset lt-lg:bottom-20px lt-lg:w-185px lt-lg:h-25px lt-lg:z-100 lt-lg:left-50% lt-lg:-translate-50% right-36px hover:scale-100">
    ...
    <div class="flex lt-lg:flex-col-reverse h-full w-full">
      ...
      <div
        class="w-50% lt-lg:w-full! lt-lg:justify-end lt-lg:pb-50px lt-lg:px-30px! lt-xxxl:w-45% flex flex-col justify-center h-full pl-200px lt-xxxl:pl-80px pr-100px lt-sm:px-10px relative lt-sm:z-10 lt-sm:mt-100px">
        ...
        <div class="flex items-center mt-70px lt-xxxl:mt-32px gap-x-25px lt-sm:gap-x-12px">
          <button @click="goToStart" class="p-22px bg-#fff w-322px lt-xxxl:w-260px lt-sm:w-176px lt-sm:p-10px lt-xxxl:p-12px q-shadow-sm__green">
            <p class="font-500 leading-28px lt-lg:leading-26px lt-sm:leading-18px text-18px lt-lg:text-18px lt-sm:text-14px">Начать заново</p>
          </button>
          <a
            :href="`http://vkontakte.ru/share.php?url=http://рускод.рф/&image=https://api.xn--d1almgfl.xn--p1ai/end_${currentPoints}.png&title=Я ${character.name}`"
            target="_blank"
            class="p-22px bg-white flex items-center justify-center q-shadow-sm__green lt-sm:p-10px lt-xxxl:p-12px">
