  ...
  &_timeout {
    ...
    &_pusskin {
      ...
      &-hand {
        ...
        transform: translate(8.68dvw, 4.93dvh);
        width: 8vw;
        height: 42vh;
        z-index: 91919;
      }
    ...
    &_timeout {
      &_pusskin {
        ...
        &-hand {
          ...
          // translate: 64.5% -84.5%;
          // transform: translate(6.4dvw, 18.8dvh);
          transform: translate(8.7dvw, 4.93dvh);
          width: 8vw;
          height: 42vh;
          z-index: 91919;
        }
    ...
    &_timeout {
      &_pusskin {
        ...
        &-hand {
          ...
          // translate: 64.5% -84.5%;
          // transform: translate(6.4dvw, 18.8dvh);
          // transform: translate(4.1dvw, 4.93dvh);
          width: 8vw;
          height: 42vh;
          z-index: 91919;
        }
    ...
    &_timeout {
      &_pusskin {
        ...
        &-hand {
          ...
          // translate: 64.5% -84.5%;
          // transform: translate(6.4dvw, 18.8dvh);
          transform: translate(6.68dvw, 4.93dvh);
          width: 10.5vw;
          height: 42vh;
          z-index: 91919;
        }
    ...
    &_timeout {
      &_pusskin {
        ...
        &-hand {
          ...
          // translate: 64.5% -84.5%;
          // transform: translate(6.4dvw, 18.8dvh);
          transform: translate(7.35dvw, 4.93dvh);
          width: 10.5vw;
          height: 42vh;
          z-index: 91919;
        }
    ...
    &_timeout {
      &_pusskin {
        ...
        &-hand {
          ...
          // translate: 64.5% -84.5%;
          // transform: translate(6.4dvw, 18.8dvh);
          transform: translate(16.3dvw, 4.93dvh);
          width: 19vw;
          height: 42vh;
          z-index: 91919;
        }
    ...
    &_timeout {
      &_pusskin {
        ...
        &-hand {
          ...
          // translate: 64.5% -84.5%;
          // transform: translate(6.4dvw, 18.8dvh);
          transform: translate(14.7dvw, 5.4dvh);
          width: 22.5vw;
          height: 34svh;
          z-index: 91919;
        }
